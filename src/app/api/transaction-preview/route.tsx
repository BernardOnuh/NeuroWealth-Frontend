      ...
      >
        ...
        >
          <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
            ...
            <div style={{ fontSize: 48, fontWeight: 700, lineHeight: 1 }}>{context.title}</div>
        ...
        <div style={{ display: "flex", gap: 18, flex: 1 }}>
          ...
          >
            <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
              ...
              <div style={{ fontSize: 16, color: palette.muted }}>{context.intro}</div>
            </div>
            ...
            {snapshot.stage === "form" ? (
              <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                ...
                >
                  <div style={{ fontSize: 16, fontWeight: 700 }}>{context.amountLabel}</div>
                  <div
                    style={{
                      minHeight: 52,
                      display: "flex",
                  ...
                  <div style={{ fontSize: 15, color: snapshot.fieldErrors.amount ? "#ef4444" : palette.muted }}>
                ...
                >
                  <div style={{ fontSize: 16, fontWeight: 700 }}>{context.walletLabel}</div>
                  <div
                    style={{
                      minHeight: 52,
                      display: "flex",
                      ...
                      borderRadius: 8,
                      border: `1px solid ${
                        snapshot.fieldErrors.walletAddress || snapshot.fieldErrors.walletConnected
                          ? "#ef4444"
                          : palette.border
                      }`,
                      padding: "0 16px",
                  ...
                  >
                    {kind === "deposit" ? context.connectedWalletAddress : snapshot.form.walletAddress}
                  </div>
                  <div
                    style={{
                      fontSize: 15,
            ...
            {snapshot.stage === "confirm" && snapshot.quote ? (
              <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                ...
                >
                  ...
                  <div style={{ fontSize: 17, color: palette.muted }}>Amount confirmed for review</div>
                </div>

                <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
                  {[
                    ["Fees", formatCurrency(snapshot.quote.fee)],
                    [kind === "deposit" ? "Total debit" : "Net destination", formatCurrency(kind === "deposit" ? snapshot.quote.totalDebit : snapshot.quote.netAmount)],
                    ...
                    >
                      ...
                      <div
                        style={{
                          fontWeight: 700,
                          fontFamily: label === "Reference" ? "\"SFMono-Regular\", Menlo, monospace" : "Inter, sans-serif",
                        }}
                      >
                        {value}
                      </div>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 18 }}>
                <div style={{ display: "flex", alignItems: "center", gap: 18 }}>
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
                    <div style={{ fontSize: 24, fontWeight: 700 }}>{snapshot.pending.statusLabel}</div>
                    <div style={{ fontSize: 16, color: palette.muted }}>{snapshot.pending.message}</div>
                  </div>
                </div>
                <div
                  style={{
                ...
                >
                  <div style={{ fontSize: 15, color: palette.muted, textTransform: "uppercase", letterSpacing: 1 }}>
                    Reference
                  </div>
                  <div style={{ fontSize: 22, fontWeight: 700, fontFamily: "\"SFMono-Regular\", Menlo, monospace" }}>
            ...
            {(snapshot.stage === "success" || snapshot.stage === "failure") && snapshot.receipt ? (
              <div style={{ display: "flex", flexDirection: "column", gap: 18 }}>
                <div
                  style={{
                    display: "flex",
                ...
                >
                  <div
                    style={{
                      fontSize: 18,
                      fontWeight: 700,
                      color: snapshot.receipt.status === "success" ? "#10b981" : "#ef4444",
                    }}
                  >
                    {snapshot.receipt.status === "success" ? "Success receipt" : "Failure state"}
                  </div>
                  <div style={{ fontSize: 26, fontWeight: 700 }}>{snapshot.receipt.message}</div>
                  <div style={{ fontSize: 16, color: palette.muted }}>
                    {snapshot.receipt.failureReason ?? "Transaction reference and amount are preserved for follow-up."}
                  </div>
                </div>
          ...
          >
            <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
              <div style={{ fontSize: 24, fontWeight: 700 }}>Validation details</div>
              <div style={{ fontSize: 16, color: palette.muted }}>
                Clear amount, wallet, and lifecycle messaging for the current preview state.
              </div>
            </div>
              ...
              >
                ...
                <div
                  style={{
                    fontSize: 17,
                    fontWeight: 700,
                    fontFamily: label === "Connected wallet" ? "\"SFMono-Regular\", Menlo, monospace" : "Inter, sans-serif",
                  }}
                >
                  {value}
                </div>

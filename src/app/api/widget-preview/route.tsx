...
export async function GET(request: Request) {
  ...
  const portfolio = buildScenarioPayload("live", { source: "demo", notice: null });
      ...
      >
        ...
        >
          <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
            ...
            <div style={{ fontSize: 52, fontWeight: 700, lineHeight: 1 }}>NeuroWealth overview</div>
          </div>
        ...
        <div style={{ display: "flex", gap: 18, flex: 1 }}>
          ...
          >
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
              <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
                <div style={{ fontSize: 24, fontWeight: 700 }}>Asset allocation</div>
            ...
            <div style={{ display: "flex", gap: 22, alignItems: "stretch", flex: 1 }}>
              ...
              >
                <div style={{ fontSize: 14, color: palette.muted, textTransform: "uppercase", letterSpacing: 2 }}>
                  Allocated
                </div>
                <div
                  style={{
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                  {portfolio.allocation.map((item, index) => (
                    ...
                    >
                      ...
                      />
                      <div style={{ fontSize: 14, color: palette.muted }}>{formatPercent(item.share)}</div>
                    </div>
                  ))}
                </div>
              </div>
                  ...
                  >
                    <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
                      ...
                      <div style={{ display: "flex", flexDirection: "column", gap: 4 }}>
                        ...
                        <div style={{ fontSize: 15, color: palette.muted }}>{item.symbol}</div>
                      </div>
                    </div>
                    <div style={{ display: "flex", alignItems: "center", gap: 24 }}>
                      ...
                      <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-end", gap: 4 }}>
                        ...
                        <div style={{ fontSize: 15, color: getToneColor(item.change) }}>
          ...
          >
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
              <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
                <div style={{ fontSize: 24, fontWeight: 700 }}>Recent activity</div>
                <div style={{ fontSize: 16, color: palette.muted }}>
              ...
              {portfolio.activity.map((item, index) => (
                ...
                >
                  <div style={{ display: "flex", flexDirection: "column", gap: 8, maxWidth: 320 }}>
                    ...
                    <div style={{ fontSize: 15, lineHeight: 1.5, color: palette.muted }}>{item.detail}</div>
                  </div>
                  <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-end", gap: 8 }}>
                    ...
                    <div style={{ fontSize: 14, color: palette.muted }}>{item.occurredAt.slice(0, 16)} UTC</div>
                  </div>
                </div>
              ))}
            </div>
